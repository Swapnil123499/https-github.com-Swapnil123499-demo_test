...
//	private String appemail;
	...
	/*	System.out.println("APPLICANT NAME:");
		...
		File appli=new File("C:\\Users\\ASUS\\test2\\"+sc.next()+".txt");//creating a file object and text file out1
	...
	sfs=sc.next();
	 ...
	 newtxtfile =sc.next();
		 ...
		 for(String p:gh)
		 {
		 if(p.equals(newtxtfile))
		 {
			 System.out.println("file found in a test2 directory...."+p);
		 }else
		 {
